...
token = '935386927:AAEgRwe9s9sXryDDGWEx-oZCb_1YQSkglZc'
...
def updateTemHum(chat_id, update_id):
    os.system("python respodReadValues.py")
...
def menu(chat_id, text, update_id):
    ...
    if text.lower() == 'updateTemHum':
        updateTemHum(chat_id, update_id)
